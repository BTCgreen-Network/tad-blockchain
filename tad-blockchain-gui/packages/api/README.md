...
This library provides support for TypeScript/JavaScript [Tad](https://www.tadnetwork.org) apps to access the [Tad Blockchain RPC](https://github.com/Tad-Network/tad-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:
...
```ts
import Client, { Wallet } from '@tad/api';
