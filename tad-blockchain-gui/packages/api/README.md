...
This library provides support for TypeScript/JavaScript [Tad](https://www.tad.net) apps to access the [Tad Blockchain RPC](https://github.com/Tad-Network/tad-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:
