...
test('Create new Wallet and logout', async () => {
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/Tad-testnet-playwright/tad-blockchain/tad-blockchain-gui/packages/gui/build/renderer/index.html#/wallet/add');
