...
test('Confirm that User cannot send a TTAD fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *TTAD >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TTAD')).toBeVisible();
});
