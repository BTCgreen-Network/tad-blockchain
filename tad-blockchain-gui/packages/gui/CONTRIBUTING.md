...
It is an input to the [tad-blockchain](https://github.com/Tad-Network/tad-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [tadvdf repo](https://github.com/Tad-Network/tadvdf) (in c/c++), and a proof of space implementation that it imports from the [tadpos repo](https://github.com/Tad-Network/tadpos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Tad-Network/bls-signatures) as blspy. There is an additional dependency on the [tadbip158 repo](https://github.com/Tad-Network/tadbip158).
...
If you want to learn more about this project, read the [wiki](https://github.com/Tad-Network/tad-blockchain/wiki), or check out the [green paper](https://www.tad.net/assets/TadGreenPaper.pdf).
