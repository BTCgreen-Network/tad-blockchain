import type { PlotNFT } from '@tad/api';
import { usePwAbsorbRewardsMutation } from '@tad/api-react';
import { AlertDialog, ConfirmDialog, UnitFormat, useOpenDialog } from '@tad/core';
