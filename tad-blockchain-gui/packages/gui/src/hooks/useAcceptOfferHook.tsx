import { OfferSummaryRecord } from '@tad/api';
import { useTakeOfferMutation } from '@tad/api-react';
import { AlertDialog, tadToMojo, useOpenDialog, useShowError } from '@tad/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? tadToMojo(fee) : new BigNumber(0);
