...
import AppIcon from '../assets/img/tad64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import tadEnvironment from '../util/tadEnvironment';
...
// Set the userData directory to its location within TAD_ROOT/gui
setUserDataDir();
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!tadEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
      app.quit();
      return false;
    }
  ...
  const getMenuTemplate = () => {
        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/tad-blockchain/wiki');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/tad-blockchain/wiki/FAQ');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Release Notes' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/tad-blockchain/releases');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/tad-blockchain/blob/main/CONTRIBUTING.md');
            },
          },
          {
            type: 'separator',
          },
          {
            ...
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/tad-blockchain/issues');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Chat on KeyBase' }),
            click: () => {
              openExternal('https://keybase.io/team/tad_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/tad_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Tad Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Tad' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Tad Blockchain' }),
            click: () => {
              openAbout();
            },
          },
