import { useDeleteUnconfirmedTransactionsMutation } from '@tad/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@tad/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToTadLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
