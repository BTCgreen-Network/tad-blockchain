...
import { useGetWalletsQuery } from '@tad/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@tad/core';
import { Tokens } from '@tad/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Tad Asset Tokens (CATs) are tokens built on top of TAD</Trans>}
