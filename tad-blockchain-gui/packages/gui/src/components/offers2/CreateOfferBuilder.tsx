...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@tad/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@tad/core';
...
type createDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (TAD), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: createDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      tad: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
