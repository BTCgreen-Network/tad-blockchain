...
import { useGetOfferSummaryMutation } from '@tad/api-react';
import { Back, Card, Dropzone, Flex, useOpenDialog, useSerializedNavigationState, useShowError } from '@tad/core';
