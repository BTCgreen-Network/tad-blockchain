...
import { useCheckOfferValidityMutation } from '@tad/api-react';
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://www.tadexplorer.com/blockchain/coin/${coin.parentCoinInfo}`,
                )
              }
            >
              {coin.parentCoinInfo}
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://www.tadexplorer.com/blockchain/puzzlehash/${coin.puzzleHash}`,
                )
              }
            >
              {coin.puzzleHash}
