import { Wallet, WalletType, type CATToken } from '@tad/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@tad/api-react';
import { Select, useCurrencyCode } from '@tad/core';
...
type BuildAssetSelectorListParams = {
  ...
  tadCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, tadCurrencyCode } = params;
