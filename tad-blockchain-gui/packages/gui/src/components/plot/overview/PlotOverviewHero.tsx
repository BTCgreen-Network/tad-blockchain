import { useRefreshPlotsMutation } from '@tad/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@tad/core';
import { Plots } from '@tad/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Tad. &nbsp;
              <Link target="_blank" href="https://github.com/BTCgreen-Network/tad-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
