import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@tad/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plot Size</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/BTCgreen-Network/tad-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
