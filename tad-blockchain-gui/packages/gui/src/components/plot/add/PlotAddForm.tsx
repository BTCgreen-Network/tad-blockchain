import { defaultPlotter, toBech32m, fromBech32m } from '@tad/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@tad/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@tad/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.TADPOS),
  });
