...
import { CardStep, Select, StateColor } from '@tad/core';
import { useGetPlottersQuery } from '@tad/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@tad/api';
import type { Plotter, PlotterMap } from '@tad/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort tadpos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.TADPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Tad Proof of Space plotter. If unsure,
            use the default Tad Proof of Space plotter.
        </Trans>
      </Typography>
