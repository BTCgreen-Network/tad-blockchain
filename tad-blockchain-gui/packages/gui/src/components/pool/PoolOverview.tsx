...
import { Flex, UnitFormat, More, Table, mojoToTadLocaleString, Suspender } from '@tad/core';
...
import { WalletStatus } from '@tad/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToTadLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
