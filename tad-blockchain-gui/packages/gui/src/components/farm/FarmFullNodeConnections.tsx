import type { Connection } from '@tad/api';
import { ServiceName } from '@tad/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@tad/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@tad/core';
