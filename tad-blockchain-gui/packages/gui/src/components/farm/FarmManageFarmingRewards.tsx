import { fromBech32m } from '@tad/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@tad/api-react';
import { Button, Flex, Form, TextField, Loading } from '@tad/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25TAD reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
