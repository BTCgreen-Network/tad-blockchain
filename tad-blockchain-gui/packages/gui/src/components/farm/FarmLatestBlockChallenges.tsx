...
import { useGetSignagePointsQuery, useGetCombinedPlotsQuery } from '@tad/api-react';
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption">
        <Trans>
          *Want to explore Tad’s blocks further? Check out{' '}
          <Link
            color="primary"
            href="https://alltheblocks.net/tad/"
            target="_blank"
          >
            Tad Explorer
          </Link>{' '}
