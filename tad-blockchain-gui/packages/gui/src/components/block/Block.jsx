...
export default function Block() {
  ...
  const baseFarmerReward = mojoToTad(calculateBaseFarmerReward(blockRecord.height));

  const tadFees = blockRecord.fees !== undefined ? mojoToTad(blockRecord.fees) : '';
  ...
  return (
    <LayoutDashboardSub>
      <Card
        title={
          <Back variant="h5">
            <Trans>Block at height {blockRecord.height} in the Tad blockchain</Trans>
          </Back>
        }
        action={
          <Flex gap={1}>
