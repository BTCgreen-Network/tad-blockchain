...
import tadToMojo from '../../utils/tadToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isTadCurrency = ['TAD', 'TTAD'].includes(currencyCode);
  const mojo = isTadCurrency ? tadToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isTadCurrency ? 12 : 3,
