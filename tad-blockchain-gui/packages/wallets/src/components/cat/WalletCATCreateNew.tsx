...
import { tadToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@tad/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = tadToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Tad Asset Token Wallet</Trans>
        </Back>
        <Card>
