import { SyncingStatus, toBech32m } from '@tad/api';
import { useSpendCATMutation, useFarmBlockMutation } from '@tad/api-react';
import {
  AdvancedOptions,
  Button,
  EstimatedFee,
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('tad_addr') || address.includes('colour_desc')) {
