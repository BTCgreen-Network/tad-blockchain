...
import { useSetCATNameMutation, useGetCatListQuery } from '@tad/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@tad/core';
import { Offers as OffersIcon } from '@tad/icons';
