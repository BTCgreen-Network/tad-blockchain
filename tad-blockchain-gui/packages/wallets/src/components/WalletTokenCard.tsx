...
import { useSetCATNameMutation } from '@tad/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@tad/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'Tad' : name;
