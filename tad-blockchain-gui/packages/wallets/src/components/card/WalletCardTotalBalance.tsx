import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@tad/api-react';
import { CardSimple, Flex, TooltipIcon } from '@tad/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for TAD, CATs, or
