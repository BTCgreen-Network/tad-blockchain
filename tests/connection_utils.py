...
from tad.server.ssl_context import tad_ssl_ca_paths
...
async def add_dummy_connection(
    ...
    tad_ca_crt_path, tad_ca_key_path = tad_ssl_ca_paths(server.root_path, config)
    dummy_crt_path = server.root_path / "dummy.crt"
    dummy_key_path = server.root_path / "dummy.key"
    generate_ca_signed_cert(
        tad_ca_crt_path.read_bytes(), tad_ca_key_path.read_bytes(), dummy_crt_path, dummy_key_path
    )
    ssl_context = ssl_context_for_client(tad_ca_crt_path, tad_ca_key_path, dummy_crt_path, dummy_key_path)
