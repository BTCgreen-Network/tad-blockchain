...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            tad_announcements: List[Announcement] = Offer.calculate_announcements(tad_requested_payments)
            tad_secured_bundle: SpendBundle = self.generate_secure_bundle(tad_coins, tad_announcements, 1000)
            tad_offer = Offer(tad_requested_payments, tad_secured_bundle)
            ...
            new_offer = Offer.aggregate([tad_offer, red_offer])
