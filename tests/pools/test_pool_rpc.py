...
from tad.wallet.derive_keys import find_authentication_sk, find_owner_sk
from tad.wallet.transaction_record import TransactionRecord
from tad.wallet.util.wallet_types import WalletType
from tad.simulator.block_tools import BlockTools, get_plot_dir
from tests.util.wallet_is_synced import wallet_is_synced
from tad.simulator.setup_nodes import setup_simulators_and_wallets_service
...
class TestPoolWalletRpc:
    ...
    async def test_absorb_self(self, one_wallet_node_and_rpc, trusted_and_fee, self_hostname):
        ...
        async with TemporaryPoolPlot(bt, status.p2_singleton_puzzle_hash) as pool_plot:
            ...
            tr: TransactionRecord = await client.send_transaction(
                1, 100, encode_puzzle_hash(status.p2_singleton_puzzle_hash, "ttad")
            )
    ...
    async def test_leave_pool(self, setup, trusted_and_fee, self_hostname):
        ...
        try:
            ...
            await time_out_assert(timeout=MAX_WAIT_SECS, function=have_tad)
