...
from tad.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from tad.daemon.server import WebSocketServer, service_plotter
from tad.server.outbound_message import NodeType
from tad.types.peer_info import PeerInfo
from tad.util.ints import uint16
from tad.util.keychain import KeyData
from tad.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
from tad.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "tad_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
