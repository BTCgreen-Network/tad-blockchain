...
from tad.data_layer.data_layer_util import NodeType, Side, Status
...
class TadRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["TAD_ROOT"] = os.fspath(self.path)
        kwargs["env"]["TAD_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("tad"),
            "--root-path",
            self.path,
            *args,
        ]
