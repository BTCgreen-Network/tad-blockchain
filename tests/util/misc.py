...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/tad-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_tad_root_popen(tad_root: TadRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
