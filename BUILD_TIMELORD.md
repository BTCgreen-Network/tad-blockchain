...
required to run a [Timelord](https://github.com/Tad-Network/tad-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Tad-Network/tad-blockchain/blob/main/install-timelord.sh)
