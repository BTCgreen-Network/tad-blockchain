...
required to run a [Timelord](https://github.com/TadNetwork/tad-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/TadNetwork/tad-blockchain/blob/main/install-timelord.sh)
