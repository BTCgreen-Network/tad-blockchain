...
from tad.daemon.server import service_launch_lock_path
...
from tad.rpc.rpc_server import RpcApiProtocol, RpcServiceProtocol, start_rpc_server, RpcServer
...
class Service(Generic[_T_RpcServiceProtocol]):
    def __init__(
        ...
        *,
        ...
        self._log.info(f"tad-blockchain version: {tad_full_version_str()}")
    ...
    async def setup_process_global_state(self) -> None:
        ...
        proctitle_name = f"tad_{self._service_name}"
