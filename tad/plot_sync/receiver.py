...
from tad.plot_sync.exceptions import (
...
from tad.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    ...
    def connection(self) -> WSTadConnection:
