...
from tad.server.ws_connection import NodeType, ProtocolMessageTypes, WSTadConnection, make_msg
...
class Sender:
    ...
    _connection: Optional[WSTadConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSTadConnection) -> None:
