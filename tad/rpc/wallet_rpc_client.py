...
from tad.data_layer.data_layer_wallet import Mirror, SingletonRecord
...
class WalletRpcClient(RpcClient):
    ...
    async def nft_mint_bulk(
        ...
        tad_coins: Optional[List[Dict]] = None,
        tad_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "tad_coins": tad_coins,
            "tad_change_target": tad_change_target,
