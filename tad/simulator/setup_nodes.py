...
from tad.simulator.block_tools import BlockTools, create_block_tools_async, test_constants
from tad.simulator.full_node_simulator import FullNodeSimulator
from tad.simulator.keyring import TempKeyring
from tad.simulator.setup_services import (
    setup_daemon,
    setup_farmer,
    setup_full_node,
    setup_harvester,
...
SimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, TadServer]], BlockTools]
...
) -> AsyncGenerator[Tuple[FullNodeAPI, FullNodeAPI, TadServer, TadServer, BlockTools], None]:
    """
...
) -> AsyncGenerator[Tuple[FullNodeAPI, WalletNode, TadServer, TadServer, BlockTools], None]:
