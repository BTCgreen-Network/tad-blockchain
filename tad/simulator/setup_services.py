...
from tad.cmds.init_funcs import init
...
from tad.data_layer.data_layer_api import DataLayerAPI
from tad.protocols.shared_protocol import Capability, capabilities
from tad.server.start_data_layer import create_data_layer_service
from tad.server.start_farmer import create_farmer_service
from tad.server.start_full_node import create_full_node_service
from tad.server.start_harvester import create_harvester_service
from tad.server.start_introducer import create_introducer_service
from tad.server.start_timelord import create_timelord_service
from tad.server.start_wallet import create_wallet_service
from tad.simulator.block_tools import BlockTools
from tad.simulator.keyring import TempKeyring
from tad.simulator.start_simulator import create_full_node_simulator_service
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["tad_spam_amount"] = tad_spam_amount
...
async def setup_farmer(
    ...
    service_config["tad_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "tad")
