...
from tad.plotters.bladebit import get_bladebit_install_info, plot_bladebit, install_bladebit
from tad.plotters.chiapos import get_chiapos_install_info, plot_tad
from tad.plotters.madmax import get_madmax_install_info, plot_madmax, install_madmax
