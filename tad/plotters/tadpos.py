"""
NOTE: This contains duplicate code from `tad.cmds.plots`.
After `tad plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
import pkg_resources
from tad.plotting.create_plots import create_plots, resolve_plot_keys
from pathlib import Path
from typing import Any, Dict, Optional

from tad.plotting.util import add_plot_directory, validate_plot_size

log = logging.getLogger(__name__)


def get_tadpos_install_info() -> Optional[Dict[str, Any]]:
    tadpos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "Tad Proof of Space", "version": tadpos_version, "installed": True}
