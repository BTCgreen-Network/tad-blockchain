...
from tad.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.tadcoins.com"
                testnet_dns_introducer = "dns-introducer-testnet10.tadcoins.com"
                bootstrap_peers = ["testnet10-node.tadcoins.com"]
                testnet = "testnet10"
                ...
                mainnet_port = "4044"
                mainnet_introducer = "introducer.tadcoins.com"
                mainnet_dns_introducer = "dns-introducer.tadcoins.com"
                bootstrap_peers = ["node.tadcoins.com"]
                net = "mainnet"
