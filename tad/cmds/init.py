...
@click.option("--testnet", is_flag=True, help="Configure this tad install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, v1_db: bool, **kwargs):
    ...
    - Get more details on remote harvester on Tad wiki:
      https://github.com/TadNetwork/tad-blockchain/wiki/Farming-on-many-machines
    """
