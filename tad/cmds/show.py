...
from tad.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'tad show -c' has been renamed to 'tad peer -c' ")
    if add_connection != "":
        print("'tad show -a' has been renamed to 'tad peer -a' ")
    if remove_connection != "":
        print("'tad show -r' has been renamed to 'tad peer -r' ")
    if wallet_rpc_port is not None:
        print("'tad show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
