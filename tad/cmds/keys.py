...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Tad versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Tad keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (tad for mainnet, ttad for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
