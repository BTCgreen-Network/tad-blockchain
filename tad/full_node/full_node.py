...
class FullNode:
    ...
    async def sync_from_fork_point(
        ...
        async def fetch_block_batches(batch_queue: asyncio.Queue, peers_with_peak: List[ws.WSTadConnection]):
            try:
        ...
        batch_queue: asyncio.Queue[Tuple[ws.WSTadConnection, List[FullBlock]]] = asyncio.Queue(maxsize=buffer_size)
