...
MASTER_PASSPHRASE_SERVICE_NAME = "Tad Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Tad Passphrase"
...
def check_legacy_keyring_keys_present(keyring: LegacyKeyring) -> bool:
    ...
    from tad.util.keychain import MAX_KEYS, default_keychain_service, default_keychain_user, get_private_key_user
...
class KeyringWrapper:
    ...
    def set_master_passphrase(
        ...
        *,
        ...
        """
        from tad.util.errors import KeychainCurrentPassphraseIsInvalid, KeychainRequiresMigration
        from tad.util.keychain import supports_os_passphrase_storage
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        from tad.util.keychain import MAX_KEYS, Keychain, get_private_key_user
