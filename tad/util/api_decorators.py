...
from tad.util.streamable import Streamable, _T_Streamable

log = logging.getLogger(__name__)

converted_api_f_type = Union[
    Callable[[Union[bytes, _T_Streamable]], Coroutine[Any, Any, Optional[Message]]],
    Callable[[Union[bytes, _T_Streamable], WSTadConnection], Coroutine[Any, Any, Optional[Message]]],
]

initial_api_f_type = Union[
    Callable[[Any, _T_Streamable], Coroutine[Any, Any, Optional[Message]]],
    Callable[[Any, _T_Streamable, WSTadConnection], Coroutine[Any, Any, Optional[Message]]],
]
