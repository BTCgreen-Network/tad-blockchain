...
from tad.plotting.util import parse_plot_info
from tad.types.blockchain_format.proof_of_space import generate_plot_public_key
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/BTCgreen-Network/tad-blockchain/issues/13084
