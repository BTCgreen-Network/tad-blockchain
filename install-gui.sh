...
# https://github.com/BTCgreen-Network/tad-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `tad version` to version property of GUI's package.json
